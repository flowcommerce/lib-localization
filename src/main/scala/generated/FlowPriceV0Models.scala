 ...
 * Service version: 0.3.95
 * apibuilder:0.12.61 https://app.apibuilder.io/flow/price/0.3.95/play_2_x_standalone_json
 */
  ...
  package object json {
    ...
    implicit def jsonReadsPriceDuty: play.api.libs.json.Reads[Duty] = {
      (
        ...
        (__ \ "components").read[Seq[io.flow.price.v0.models.LevyComponent]] and
        (__ \ "deminimis").readNullable[io.flow.price.v0.models.Deminimis] and
