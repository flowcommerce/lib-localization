 ...
 * apibuilder:0.12.38 https://app.apibuilder.io/flow/item/0.3.60/play_2_x_standalone_json
 */
package io.flow.item.v0.models {
   ...
   * @param price The localized item.price for this experience. This represents the
   * price a consumer will pay to purchase this item in this experience.
   * @param attributes All attributes with intent price as keys of this map - with
   * each of those attributes mapped to its value in the local currency. For example,
   * given an attribute named 'msrp' with intent 'price', this map will contain a key
   * named 'msrp'
   */
