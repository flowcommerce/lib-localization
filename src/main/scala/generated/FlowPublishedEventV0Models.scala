 ...
 * apibuilder:0.12.61 https://app.apibuilder.io/flow/published-event/0.4.7/play_2_x_standalone_json
 */
...
package io.flow.published.event.v0.models {
  ...
  package object json {
    ...
    implicit def jsonWritesPublishedEventOrganizationRatecardTransitWindowsPublished: play.api.libs.json.Writes[OrganizationRatecardTransitWindowsPublished] = {
      new play.api.libs.json.Writes[io.flow.published.event.v0.models.OrganizationRatecardTransitWindowsPublished] {
        def writes(obj: io.flow.published.event.v0.models.OrganizationRatecardTransitWindowsPublished) = {
          jsObjectOrganizationRatecardTransitWindowsPublished(obj)
        }
      }
    }
